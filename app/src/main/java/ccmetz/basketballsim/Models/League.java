...
public class League implements Serializable
{
  ...
  public void simCurrentWeek()
  {
    ...
    // DEBUG
    Log.d("Team Ranking", "Week: " + currentWeek);
    for (Team team : leagueTeamList)
    {
      Log.d("Team Ranking", team.getTeamName() + "=> " + team.getRanking()
          + ":" + team.getPollScore() + " Ovr: " + team.getTeamOverall()
          + " Record: " + team.getWins() + "-" + team.getLosses());
    }
    Log.d("Team Ranking", "----------------------------------------------------");
  }
  ...
  */
  ...
  public void calcTeamRankings()
  {
    ...
    Sorter.sortByPollScore(leagueTeamList);
    int ranking = 1;
    for (Team team : leagueTeamList)
    {
